...
if(!isset($_SESSION['userid']))
	...
	if(!checkifsolved($con,$_SERVER['REQUEST_URI']))
	{
		...
		if(empty($_POST['flag']) || sanitize($con,$_POST['flag'])!='mentalselffive'){
			
			echo ' PACK MY BOX WITH FIVE DOZEN LIQUOR JUGS</br></br>';
			echo 'PLDFMDQLNVVTIL<br /> <br/>
			...
			echo '<a href="question8.php">Next &rarr;</a><span>';
